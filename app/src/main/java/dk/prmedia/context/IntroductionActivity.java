...
public class IntroductionActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCursorAdapter = new SentenceCursorAdapter(this, null, R.color.cat_intr);
        ...
        SentenceListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Intent intent = new Intent(IntroductionActivity.this, DetailActivity.class);
