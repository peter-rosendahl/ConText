...
public class DirectionsActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor>  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCursorAdapter = new SentenceCursorAdapter(this, null, R.color.cat_dire);
        ...
        SentenceListView.setOnItemClickListener(new AdapterView.OnItemClickListener(){
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Intent intent = new Intent(DirectionsActivity.this, DetailActivity.class);
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        return new CursorLoader(this,       // Parent activity context
                ...
                new String[] {"3"},         // 4 = CATEGORY_VARIOUS
                null);                      // No sort order
    }
